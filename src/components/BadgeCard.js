...
const styles = StyleSheet.create({
  ...
  name: { color: COLORS.white, fontFamily: FONTS.sansBold, fontSize: 12, textAlign: 'center' },
  desc: { color: 'rgba(255,255,255,0.5)', fontFamily: FONTS.sans, fontSize: 10, textAlign: 'center', lineHeight: 14 },
  ...
  earnedText: { color: '#4edea3', fontFamily: FONTS.monoBold, fontSize: 7.5, letterSpacing: 1 },
});
